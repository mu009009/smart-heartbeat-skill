...
class SmartHeartbeatSystemV2:
    ...
    def should_send_heartbeat(self):
        ...
        print(f"  距上次消息: {int(time_since_last_message // 60)}分钟")
        ...
        if state['last_heartbeat']:
            ...
            print(f"  距上次心跳: {int(time_since_last_heartbeat // 60)}分钟")
        ...
        # 还没到时间
        remaining = (next_heartbeat_time - current_time).total_seconds()
